      ...
      <div className="bg-white text-gray-800">
        ...
        <section className="bg-yellow-400 px-4 py-10 text-black">
          <div className="max-w-4xl mx-auto pl-6 border-l-2 border-gray-800 text-xl leading-relaxed space-y-1">
            <div className="py-2">
              <p>Garment pattern CAD software for discerning customers.</p>
              <p>Garment pattern CAD that saves time and fabric.</p>
              <p>Garment CAD software that enables consistent quality. Every time.</p>
              <p>Garment CAD software that enables your team to collaborate seamlessly to deliver on time.</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-5xl mx-auto">
            ...
            */}
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-md max-w-3xl mx-auto text-left space-y-6 text-2xl font-medium leading-relaxed text-gray-800">
              <p>Eliminate human errors in pattern design.</p>
              <p>
                Errors can creep in when patterns are made manually for many reasons. <br />
                Manual pattern making process is laborious, repetitive and the most disciplined pattern maker too can slack off at times.
              </p>
              <p>
              ...
              <p>
                ...
                With REACH CAD your pattern making process is effortless. <br />
