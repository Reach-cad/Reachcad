      ...
      <div className="bg-white text-gray-800">
        ...
        <section className="bg-yellow-400 px-4 py-10 text-black">
          <div className="max-w-4xl mx-auto pl-6 border-l-2 border-gray-800 text-xl leading-relaxed space-y-1">
            <div className="py-2">
              <p>Clothing CAD software for discerning customers.</p>
              <p>Clothing CAD that saves time and fabric.</p>
              <p>Clothing pattern CAD software that enables consistent quality. Every time.</p>
              <p>Clothing pattern CAD software that enables your team to collaborate seamlessly to deliver on time.</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-5xl mx-auto">
            ...
            */}
            ...
            <div className="text-left space-y-6 text-2xl font-medium leading-relaxed text-gray-800">
              <p>Add precise seam and other allowances to patterns easily.</p>
              <p>Precise seam and other allowances to patterns are critical in garment construction.</p>
              <p>
                Manually this takes a lot of time and is prone to errors. A error in this can impact the overall construction of the garment.
              </p>
              <p>With REACH CAD, you automate this process ensuring speed and accuracy.</p>
              {/* 
              <Link
                to="/brochure"
