      ...
      <div className="bg-white text-gray-800">
        ...
        <section className="bg-yellow-400 px-4 py-10 text-black">
          <div className="max-w-4xl mx-auto pl-6 border-l-2 border-gray-800 text-xl leading-relaxed space-y-1">
            <div className="py-2">
              <p>Apparel pattern CAD software for discerning customers.</p>
              <p>Apparel pattern CAD that saves time and fabric.</p>
              <p>Apparel CAD software that enables consistent quality. Every time.</p>
              <p>Apparel CAD software that enables your team to collaborate seamlessly to deliver on time.</p>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-10 max-w-5xl mx-auto">
            ...
            */}
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-md max-w-3xl mx-auto text-left space-y-6 text-2xl font-medium leading-relaxed text-gray-800">
              <p>Make patterns anywhere and modify them anywhere without the need for pattern tables and tools.</p>
              <p>With REACH CAD you can create or modify patterns any where, any time.</p>
              <p>No need to for pattern tables, associated tools or pattern paper.</p>
              <p>Retrieve earlier patterns and make changes or create entirely new patterns when you are free during the day or at night.</p>
              {/*
              <Link
                to="/brochure"
