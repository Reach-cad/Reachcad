      ...
      <div className="bg-white text-gray-800">
        ...
        <section className="bg-yellow-400 px-4 py-10 text-black">
          <div className="max-w-4xl mx-auto pl-6 border-l-2 border-gray-800 text-xl leading-relaxed space-y-1">
            <div className="py-2">
              <p>Apparel marker CAD software for discerning customers.</p>
              <p>Apparel marker CAD that saves time and fabric.</p>
              <p>Apparel marker CAD software that enables consistent quality. Every time.</p>
              <p>Apparel marker CAD software that enables your team to collaborate seamlessly to deliver on time.</p>
            </div>
        ...
        <section className="text-center py-12 px-4">
          ...
          <div className="flex justify-center">
            <div className="bg-gray-50 p-8 rounded-xl shadow-md max-w-3xl text-left space-y-6 text-2xl font-medium leading-relaxed text-gray-800">
              <p>Calculate fabric consumption quickly while doing costing or fabric procurement.</p>
              <p>Fabric cost is often a significant part of the garment cost.</p>
              <p>Being able to accurately arrive at fabric consumption is key to a profitable apparel enterprise.</p>
              <p>With REACH CAD, you can easily generate 'Mini Markers', email these to various team members, discuss and arrive at important decisions on costing or fabric procurement.</p>
            </div>
          </div>
        </section>
